namespace G56
{
	...
	template<int dim>
	class
	Base_G56:public EquationGenerator::Base_EquationGenerator<dim>
	{
		public:
			Base_G56(const constant_data &constants,
