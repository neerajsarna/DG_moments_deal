namespace G20
{
	...
	template<int dim>
	class
	Base_G20:public EquationGenerator::Base_EquationGenerator<dim>
	{
		public:
			Base_G20(const constant_data &constants,
						std::string &folder_name);
			

			// prepare varIdx for systemA, since we do not have a one to one correspondence with 
			const unsigned int Ntensors = 6;
	};
	...
	::G20(const constant_data &constants,
			  std::string &folder_name)
	:
	Base_G20<dim>(constants,folder_name),
