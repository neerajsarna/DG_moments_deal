...
echo "Test Multi Core Kn0p1 Odd Boundary Conditions"
        export GTEST_OUTPUT="$BaseDir/G35_Kn0p1_Odd_MultiCore.xml"
        ./test.out 4 -p ../test_input_files/G35/input_G35_periodic_odd_Kn0p1.in

echo "Test Multi Core Kn0p1 Char Boundary Conditions"
        export GTEST_OUTPUT="$BaseDir/G35_Kn0p1_Char_MultiCore.xml"
        ./test.out 4 -p ../test_input_files/G35/input_G35_periodic_char_Kn0p1.in
...
echo "Test Multi Core Kn0p3 Odd Boundary Conditions"
        export GTEST_OUTPUT="$BaseDir/G35_Kn0p3_Odd_MultiCore.xml"
        ./test.out 4 -p ../test_input_files/G35/input_G35_periodic_odd_Kn0p3.in

echo "Test Multi Core Kn0p3 Odd Boundary Conditions"
        export GTEST_OUTPUT="$BaseDir/G35_Kn0p3_Char_MultiCore.xml"
        ./test.out 4 -p ../test_input_files/G35/input_G35_periodic_char_Kn0p3.in