...
namespace ExactSolution
{
	...
	template<int dim>
	G20_PoissonHeat<dim>::G20_PoissonHeat(const constant_data &constants,const Sparse_matrix &S_half)
	:
	...
	template<int dim>
	void
	G20_PoissonHeat<dim>::vector_value(const Point<dim> &p,Vector<double> &value) const
	{
